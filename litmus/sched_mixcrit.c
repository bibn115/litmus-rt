...
{
  /**bheap_iterate_clear(edfvd_check_criticality,edf_ready_order,&edfvd.release_queue,&edfvd_release_bin); **/
...
static void lower_criticality(void)
{
     ...
     * parameter reset.
     * */
    bheap_iterate_add(edfvd_reset_params,edf_ready_order,&edfvd.release_queue,&edfvd_release_bin);
